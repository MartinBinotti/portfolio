        ...
        <div className="section-container">
          <div className="section-header">
            ...
            <h2 className="section-title">
              ...
              <span className="title-text" data-text-en="About Me">
                About Me
              </span>
              <span className="title-bracket">/&gt;</span>
            </h2>
            ...
            <div className="about-text-wrapper">
              <div className="about-intro">
                <p
                  ...
                  data-text-en="I am a Full Stack Developer focused on building and implementing web systems and e-learning platforms using PHP, Laravel, JavaScript, HTML, CSS3, MySQL/MariaDB, WordPress, VTEX and Moodle. I work across development, layout implementation, content and server management, and I apply cybersecurity best practices while continuously strengthening React, Vue.js and Python."
                >
                  I am a Full Stack Developer focused on building and implementing web systems and
                  e-learning platforms using PHP, Laravel, JavaScript, HTML, CSS3, MySQL/MariaDB,
                  WordPress, VTEX and Moodle. I work across development, layout implementation,
                  content and server management, and I apply cybersecurity best practices while
                  continuously strengthening React, Vue.js and Python.
                </p>
              </div>
              ...
              <div className="about-stats">
                <div className="stat-item">
                  ...
                  <div className="stat-label" data-text-en="Projects">
                    Projects
                  </div>
                </div>
                <div className="stat-item">
                  ...
                  <div className="stat-label" data-text-en="Years Experience">
                    Years Experience
                  </div>
                </div>
                <div className="stat-item">
                  ...
                  <div className="stat-label" data-text-en="Happy Clients">
                    Happy Clients
                  </div>
                </div>
              </div>
