...
const ES_TRANSLATIONS = {
    ...
    "GitHub": "GitHub",
    "Hello, I'm": "Hola, soy",
    "Full Stack Web Developer | Web Platforms & E-learning Solution": "Desarrollador Web Full Stack | Plataformas Web y Soluciones de E-learning",
    "Passionate developer creating exceptional digital experiences with modern technologies.": "Desarrollador apasionado creando experiencias digitales excepcionales con tecnologias modernas.",
    "Get In Touch": "Contactame",
    "View Projects": "Ver proyectos",
    "Scroll Down": "Desplazate hacia abajo",
    "About Me": "Sobre mi",
    "I am a Full Stack Developer focused on building and implementing web systems and e-learning platforms using PHP, Laravel, JavaScript, HTML, CSS3, MySQL/MariaDB, WordPress, VTEX and Moodle. I work across development, layout implementation, content and server management, and I apply cybersecurity best practices while continuously strengthening React, Vue.js and Python.": "Soy un desarrollador Full Stack enfocado en construir e implementar sistemas web y plataformas de e-learning usando PHP, Laravel, JavaScript, HTML, CSS3, MySQL/MariaDB, WordPress, VTEX y Moodle. Trabajo tanto en desarrollo como en maquetado, actualizacion de contenidos y gestion de servidores, aplicando buenas practicas de ciberseguridad mientras sigo fortaleciendo React, Vue.js y Python.",
    "Projects": "Proyectos",
    ...
    "Leading a team of developers in building complex web applications using React and Node.js. Developing advanced user interfaces and optimizing performance. Implementing microservices architecture and CI/CD pipelines.": "Liderando un equipo para construir aplicaciones web complejas con React y Node.js, optimizando rendimiento e implementando CI/CD.",
    "Developed interactive user interfaces using React and Vue.js. Worked on improving user experience and performance optimization. Collaborated with designers to implement pixel-perfect designs.": "Desarrolle interfaces interactivas con React y Vue.js, mejorando experiencia de usuario y rendimiento.",
    "Developed websites using HTML, CSS, and JavaScript. Learned best practices in web development. Worked on various client projects and gained experience in modern web technologies.": "Desarrolle sitios con HTML, CSS y JavaScript, aplicando buenas practicas en proyectos reales.",
    ...
    "A complete e-commerce platform with payment integration and advanced inventory management.": "Una plataforma e-commerce completa con integracion de pagos y gestion avanzada de inventario.",
    "A web application for task management with real-time synchronization and modern design.": "Aplicacion web para gestion de tareas con sincronizacion en tiempo real y diseno moderno.",
    "A modern blog platform with CMS features and beautiful UI design.": "Plataforma de blog moderna con funciones CMS y una interfaz cuidada.",
    "Email": "Correo",
    "Phone": "Telefono",
    "Location": "Ubicacion",
